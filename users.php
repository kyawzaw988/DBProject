...
<body>
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-item nav-link" id="nav-add-tab" data-toggle="tab" href="#add">Add New</a>
  </div>
...
<div class="tab-content" id="nav-tabContent">
  ...
  <form action="" method="post" class = "register">
          ...
          <select type="text" name = "level" id="level" class= "form-control">
            <option value="0" selected>0 - Ready Only</option>
          ...
          <br>
          <button name ="btnCreateUser" class ="btn btn-primary">Register</button>
